...
data class Message(
    ...
    val senderId: String,        // LOGICAL AuthorID (resolved human identity)
    val senderName: String,
    val deviceId: String? = null, // PHYSICAL DeviceID (BLE UUID/carrier)
    ...
    // AI Attribution (for messages generated by AI assistant)
    val aiGenerated: Boolean = false,           // Was this message generated by AI?
    val aiModel: String? = null,                // Model used: "qwen3-1.7b-q4", "rule-based", or null
    val aiSource: String? = null,               // Source type: "llm", "rule-based", "online"
    ...
    val archivedAt: Long? = null,               // When was it archived?
    val archiveReason: String? = null,          // Why was it archived? (job completion, etc.)
    val relatedJobId: String? = null            // Associated job ID if archived with a job
) {
    
    /** Check if this is an AI-generated message */
    fun isAIGenerated(): Boolean = aiGenerated
    
    /** Get the AI source display label */
    fun getAISourceLabel(): String? {
    ...
    companion object {
        ...
        /** AI Assistant sender ID */
        const val AI_SENDER_ID = "ai-assistant"
        const val AI_SENDER_NAME = "Smith AI"
