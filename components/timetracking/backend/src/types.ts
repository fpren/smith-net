...
export interface TimeEntry {
  ...
  // Clock-out context (immutable once set)
  clockOutContext?: ClockOutContext;
...
export interface ClockOutContext {
  ...
  content: string;
  generatedAt: number;
  generatedBy: string; // Worker userId or 'ai'
...
export interface ClockOutRequest {
  ...
  workerNote?: string; // Manual note from worker
  // aiSummary will be generated by AI based on work performed
}
